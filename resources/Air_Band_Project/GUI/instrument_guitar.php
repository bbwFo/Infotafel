    ...
    <div id="site_wrapper">
        ...
        <div class="color_settings_container">
            ...
            <div id="instrumentSettingsMenu">
                 <h1 style="margin-bottom: 0;">Guitar Settings</h1>
                <hr style="margin-bottom: 20px;">
                <!-- <label for="instrumentSoundSelect">Guitar Sounds:</label>
                <select id="instrumentSoundSelect">
                        <option value="powerChords">Power Chords</option>
                        <option value="soloGuitar">Solo Guitar</option>
                        <option value="acousticGuitar">Acoustic Guitar</option>
                </select><br>
                <input type="checkbox" id="palmMuteCheckbox">Palm Mute
                <input type="checkbox" id="shredModusCheckbox" onclick="ShredModusFunction()">Shred Modus
