...
<head>
    ...
    <title>AIR BAND | SCHLAGZEUG</title>
</head>
<body>
    <div id="site_wrapper">
        <div id="container">
            ...
            <?php
                include ("logic/instrument_drums_logic.php");
            ?>
            ...
            <!-- <img src="img/drums_template.png" alt="drums_template.png"> -->
            <div id="instrumentSettingsMenu">
                <h1 style="margin-bottom: 0;">Drums Settings</h1>
                <hr style="margin-bottom: 20px;">
                <!--
                <label for="instrumentSoundSelect">Drum Sounds:</label>
                <select id="instrumentSoundSelect">

                        <option value="claissicKit">Claissic Kit</option>
                        <option value="epicKit">Epic Kit</option>
                        <option value="randomSounds">Random Sounds</option>
                </select><br>
                <input type="checkbox" id="blastModusCheckbox" onclick="BlastModusFunction()">Blast Modus
        	    <br>
            -->
                <?php include (".inc/instrument_settings.inc.php"); ?>              
